...
```bash
# デフォルト値で自動生成（CI/CD向け）
cookiecutter gh:kyouyap/python-template-for-claude-code-cookiecutter --no-input
...
```bash
cookiecutter https://github.com/kyouyap/python-template-for-claude-code-cookiecutter
```
